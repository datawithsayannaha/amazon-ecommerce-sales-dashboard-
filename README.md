...
Checked for null values, duplicates, incorrect joins, invalid rows
Validated key columns: customer_id, order_id, product_id, date fields

Output — Star Schema:
Fact Table: fact_sales

Built at order item level — includes order_id, customer_id, product_id, revenue, profit, margin_pct, delivery_days, delayed, payment_method, and more.
...
fact_sales.csv, dim_customer.csv, dim_product.csv

What I created:
Output FileDescriptioncustomer_upgrade.csvExtended customer data with CLTV and improved segmentationcohort_analysis.csvCohort month, cohort index, retention ratemonthly_summary.csvMonthly orders, revenue, profit, AOVrolling_metrics.csv3-month rolling revenue, profit, and ordersfunnel_data.csvFunnel stages with conversion ratesreview_summary.csvProduct-level avg rating and total reviews
...
Summary tables (cohort, funnel, monthly, rolling) used as standalone reporting tables.
DAX Measures Created:

Total Revenue, Total Profit, Profit Margin %, Avg Order Value
Delayed Orders, Delayed Order %, Avg Delivery Days
High Value Customers, At Risk Customers, Avg CLTV, Total CLTV
Avg Product Rating, Total Reviews
View → Wishlist, View → Cart, View → Purchase conversion rates
...
Total Orders: 20,000 | Total Customers: 8,635
Profit Margin: 30% (Goal: 35% ⚠️)
Avg Order Value: ₹595.93

Visuals: Revenue trend, Profit trend, Payment method donut, Delivery by city, Top categories

Page 2 — Customer Insights & Segmentation
Key Numbers:

High Value Customers: 185
At Risk Customers: 5,435 (54.4% of base ⚠️)
Total CLTV: ₹14.98M | Avg CLTV: ₹1.50K

Visuals: Segment donut, Top cities by CLTV, Segment value chart, Customer behavior scatter, Customer detail table

Page 3 — Product Performance & Reviews
Key Numbers:

Total Product Sales: ₹11.92M | Profit: ₹3.58M
Avg Rating: 3.55 / 5 | Total Reviews: 15K

Visuals: Category treemap, Brand-wise profit, Top 10 products, Rating vs Sales bubble chart, Category summary table
...
Visuals: Full cohort heatmap matrix (Jan 2024 → Jan 2025), Month 2 retention bar chart, Month 3 retention bar chart
...
Delivered On Time: 18K | Delayed: 2K
Avg Delivery Time: 4 days | Delayed %: 20%

Visuals: Customer journey funnel (10K view → 3K purchase), Delivery trend over time, Orders by payment method

🎨 Dashboard Design

Theme: Amazon-inspired dark navy background
Colors: Orange, Blue, Green, Red highlights
Features: Custom page navigation icons, consistent layout, clear visual hierarchy


💡 Key Business Insights

Revenue exceeded target by 11% — strong overall performance
54% customers are At Risk — urgent need for re-engagement campaigns
...
✅ Python — cohort analysis, funnel analysis, rolling metrics, feature engineering
✅ Power BI — data modeling, relationships, DAX, interactive multi-page dashboard
